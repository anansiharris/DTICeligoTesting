/* eslint-disable */
/* Auto-generated from celigo/PreMap/MAR08FoodLion - PreMaps.js */
...
function __celigoInvoke(options) {
  ...
  if (!__impl) {
    throw new Error(
      "No callable function found. Expected one of: transform, preMap"
    );
  }
...
module.exports = { transform: __celigoInvoke, preMap: __celigoInvoke };
