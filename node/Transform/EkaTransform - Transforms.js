/* eslint-disable */
/* Auto-generated from celigo/Transform/EkaTransform - Transforms.js */
...
function __celigoInvoke(options) {
  ...
  const __impl =
    (typeof jsonAPIRequestParseResponse === "function" && jsonAPIRequestParseResponse) ||
    (typeof transform === "function" && transform) ||
    null;

  if (!__impl) {
    throw new Error(
      "No callable function found. Expected one of: jsonAPIRequestParseResponse, transform"
    );
  }
...
module.exports = { jsonAPIRequestParseResponse: __celigoInvoke, transform: __celigoInvoke };
